...
namespace Private.Storages.Migrations
{
    ...
    [Migration("20250513124306_AddManagerIdToCar")]
    partial class AddManagerIdToCar
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Private.StorageModels.ApplicationUserEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Private.StorageModels.BlackListTokenAccessEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Private.StorageModels.CarEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Private.StorageModels.EmailConfirmationTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Private.StorageModels.PhotoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Private.StorageModels.PhotoMetadataEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Private.StorageModels.RefreshTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RefreshTokenBody")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Private.StorageModels.ApplicationUserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Private.StorageModels.CarEntity", b =>
                {
                    b.HasOne("Private.StorageModels.PhotoMetadataEntity", "PhotoMetadata")
                        .WithOne("Car")
                        .HasForeignKey("Private.StorageModels.CarEntity", "PhotoMetadataId")
            ...
            modelBuilder.Entity("Private.StorageModels.EmailConfirmationTokenEntity", b =>
                {
                    b.HasOne("Private.StorageModels.ApplicationUserEntity", "User")
                        .WithOne("EmailConfirmationToken")
                        .HasForeignKey("Private.StorageModels.EmailConfirmationTokenEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Private.StorageModels.RefreshTokenEntity", b =>
                {
                    b.HasOne("Private.StorageModels.ApplicationUserEntity", "ApplicationUser")
