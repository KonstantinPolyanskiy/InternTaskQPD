...
namespace QPDCar.Infrastructure.Migrations
{
    ...
    [Migration("20250523120638_AppUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.ApplicationUserEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.BlackListAccessTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.CarEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<Guid>("ResponsiveManagerId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.EmailConfirmationTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.PhotoDataEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.PhotoMetadataEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.RefreshTokenEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QPDCar.Models.StorageModels.ApplicationUserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.CarEntity", b =>
                {
                    b.HasOne("QPDCar.Models.StorageModels.PhotoMetadataEntity", "PhotoMetadata")
                        .WithOne("Car")
                        .HasForeignKey("QPDCar.Models.StorageModels.CarEntity", "PhotoMetadataId")
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.EmailConfirmationTokenEntity", b =>
                {
                    b.HasOne("QPDCar.Models.StorageModels.ApplicationUserEntity", "User")
                        .WithOne("EmailConfirmationToken")
                        .HasForeignKey("QPDCar.Models.StorageModels.EmailConfirmationTokenEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("QPDCar.Models.StorageModels.RefreshTokenEntity", b =>
                {
                    b.HasOne("QPDCar.Models.StorageModels.ApplicationUserEntity", "ApplicationUser")
